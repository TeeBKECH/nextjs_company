        ...
        <div className={styles.container}>
          ...
          <div className={clsx(styles.work_items, !workWithShowAll && styles.work_items_all)}>
            ...
            <div className={styles.work_item}>
              ...
              />
              <p>
                Владельцам отеля, которые ищут возможности сократить расходы и оптимизировать
            ...
            <div className={styles.work_item}>
              ...
              <p>
                ...
                или отеля и заинтересованы в том, чтобы не допустить ошибки в дальнейшем при
