      ...
      <section className={styles.work}>
        <div className={styles.container}>
          <div className={styles.work_title}>
            <TitleSec
              title={'Мы поможем, если Вы являетесь:'}
              align='center'
            />
          </div>
          <div className={clsx(styles.work_items, !workWithShowAll && styles.work_items_all)}>
            <div className={styles.work_item}>
              ...
              />
              <p>
                Владельцем зданий и помещений, который планирует зарабатывать на них больше прибыли,
                чем от их аренды
              </p>
            </div>
            <div className={styles.work_item}>
              ...
              />
              <p>
                Собственником здания/помещения, который заинтересован в повышении капитализации
                своего объекта.
              </p>
            </div>
            <div className={styles.work_item}>
              ...
              />
              <p>
                Владельцем отеля, который ищет возможности сократить расходы и оптимизировать
            ...
            <div className={styles.work_item}>
              ...
              />
              <p>
                Собственником, кто сдавал в аренду помещения под отель, но арендатор ушел из этого
                помещения.
              </p>
            </div>
            <div className={styles.work_item}>
              ...
              />
              <p>
                Владельцем загородной недвижимости и земли (кроме ИЖС) в поиске оптимального решения
            ...
            <div className={styles.work_item}>
              ...
              />
              <p>
                Дизайнером, архитектором или строителем, которые разрабатывают концепцию ресторана
                или отеля и заинтересованы в профессиональном сопровождении проекта с целью
                исключить ошибки, которые могут возникнуть в дальнейшем при эксплуатации объекта
              </p>
            </div>
            <div className={styles.work_item}>
              <Image
              ...
              />
              <p>
                Предпринимателем, который планирует инвестировать в отельный бизнес и находится в
            ...
            <div className={styles.work_item}>
              ...
              />
              <p>
                Владельцем отеля или ресторана, который стремится привести сервис в соответствие с
      ...
      >
        <div className={styles.team_title}>
          ...
          <p className={styles.team_title_sub}>
            ...
            проекта: от консалтинга и разработки концепции до эффективного управления и вывода отеля
            на уровень стабильного дохода. Мы будем рады приступить к работе над вашим проектом в
        ...
        <div className={styles.container}>
          <div className={styles.adventages_title}>
            ...
            <p className={styles.adventages_title_sub}>
              Помогаем справиться с самыми сложными задачами отельного бизнеса. Оптимизируем все
